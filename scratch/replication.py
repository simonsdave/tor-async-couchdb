...
def main():
    ...
    assert fire_replication(host, db1, db2)

    assert_docs_equal(
        get_document(host, db1, doc_id),
        get_document(host, db2, doc_id))

    update_document(host, db1, get_document(host, db1, doc_id))
    ...
    update_document(host, db1, get_document(host, db1, doc_id))
    update_document(host, db2, get_document(host, db2, doc_id))
